...
*/
	{
		...
		switch ($sort) {
			...
			case 'tagscore':
			    $sortsql='ORDER BY (select sum(w.tagcount)/count(w.wordid) from ^posttags pt,^words w  where 1=1 and pt.postid=^posts.postid and pt.wordid=w.wordid) DESC, ^posts.created DESC';
				break;
