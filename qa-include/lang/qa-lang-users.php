...
*/
	...
	return array(
		'about' => 'Tentang',
		'add_user_x_favorites' => 'Tambahkan user ^ ke favorit saya',
		'approve_required' => 'Tunggu akun Anda disetujui untuk ^1tambah lebih banyak info^2.',
		'approve_title' => 'User diterima yang tertunda',
		'approve_user_button' => 'Terima user',
		'approved_user' => 'Diterimakan user',
		'avatar_default' => 'Default',
		'avatar_gravatar' => 'Munculkan ^1Gravatar^2',
		'avatar_label' => 'Avatar:',
		'avatar_none' => 'None',
		...
		'confirm_wrong_log_in' => 'Kode tidak benar - silakan login FB Anda (kiri atas) untuk mengirimkan lagi',
		'confirm_wrong_resend' => 'Kode tidak benar - silakan klik di bawah ini untuk mengirimkan lagi',
		'delete_user_button' => 'Hapus user',
		'edit_profile' => 'Ubah profil saya',
		'edit_user_button' => 'Ubah user',
		...
		'last_login_label' => 'Login terakhir kali:',
		...
		'location' => 'Lokasi',
		'log_in_to_access' => 'Anda sekarang bisa login FB Anda (kiri atas) untuk mengakses akun.',
		'login_button' => 'Masuk',
		...
		'unsubscribe_wrong_log_in' => 'Kode tidak benar - silakan login FB Anda (kiri atas) untuk keluar dari daftar.',
		'unsubscribe' => 'Keluar dari daftar:',
